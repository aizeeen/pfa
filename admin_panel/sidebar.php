...
<div class="side-header">
    <img src="./assets/images/adminlogo2.jpg" width="120" height="120" alt="Swiss Collection"> 
    <h5 style="margin-top:10px;">Asslema, Admin</h5>
</div>

<hr style="border:1px solid; background-color:#27ae60; border-color:#27ae60;">
    <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">×</a>
    <a href="./indexadminpanel.php" ><i class="fa fa-home"></i> Dashboard</a>
